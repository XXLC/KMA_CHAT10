...
- ## Lịch sử tư tưởng triết học Việt Nam
  ...
  * Những nội dung của tư tưởng yêu nước Việt Nam
    ...
    - Yêu nước là truyền thống của dân tộc -> **trở thành hệ thống lý luận**
  ...
  * Giá trị truyền thống VN
    ...
    - => Triết học VN do hoàn cảnh xã hội -> gắn với công cuộc xây dựng + bảo vệ đất nước
      - => Triết học VN hướng đến vấn đề nhân sinh - trung tâm là tư tưởng yêu nước
      - Triết học Hy Lạp: xu hướng TG quan -> nhân sinh quan: Triết học VN có xu hướng ngược lại
      - Vấn đề cơ bản của triết học VN khá mờ nhạt -> Cuộc đấu tranh giữa CNDV vs CNDT không trải ra trên khắp mọi vấn đề
      - Do ảnh của PTSX châu Á -> các giai đoạn phát triển của triết học (xã hội) VN không rõ ràng như ở phương Tây
      - Xét về mặt tôn giáo: không sâu sắc như triết học Ấn Độ
        - Xét về mặt tôn ti trật tự, luân lý đạo đức: không cứng nhắc như triết học Trung Hoa
          - Về mặt tình cảm: sâu đậm hơn <- Thể hiện ở ca dao tục ngữ văn hoa nghệ thuật...
  * Đạo đức nghề nghiệp
...
- ## Lịch sử triết học Mác
  - Những điều kiện cho sự ra đời của CN Mác
    - Điều kiện kinh tế - xã hội
      - Khi PTSX tư bản lên tới đỉnh cao -> mâu thuẫn xã hội cũng lên tới đỉnh cao
...
- ## Bản thể luận và nhận thức luận trong triết học
  - => Giải quyết các vấn đề cơ bản trong triết học
  - Bản thể luận: trả lời cho câu hỏi bản nguyên của thế giới là gì -> nhiều quan điểm khác nhau
  ...
  - Một số quan niệm vật chất trong lịch sử và quan niệm mới của CNDVBC về vật chất
    - Định nghĩa vật chất của phương Đông cổ đại: ngũ hành -> 5 yếu tố khởi nguyên -> tạo nên vạn vật
    - Định nghĩa vật chất của Lenin: vật chất là phạm trù triết học dùng để chỉ thực tại khách quan được đem lại cho con người trong cảm giác, được cảm giác chép lại, chụp lại, phản ánh và tồn tại không lệ thuộc vào cảm giác
      ...
      - Gây lên cảm giác của con người
        - => Giải thích vấn đề cơ bản của triết học theo DV
  ...
  - Phương thức tồn tại của vật chất là vận động
    ...
    - Thời gian: là khái niệm dùng để chỉ sự kế tiếp, độ dài diễn biến, chuyển hóa nhanh hay chậm của các quá trình
      - chiều của TG: chỉ có 1 chiều - chiều từ quá khứ -> tương lai
